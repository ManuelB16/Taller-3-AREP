package arep.taller2.web.Utils;
...
public class HttpServer {
    ...
    public static void loadComponents() {
        File filesController = new File("src\\main\\java\\arep\\taller2\\web\\Controller");
            ...
            try {
                ...
                for (int i = 0; i < annotations.length; i++) {
                    for (Annotation annotation : annotations[i]) {
                        if (annotation instanceof ReParam) {
                            ReParam requestParam = (ReParam) annotation;
